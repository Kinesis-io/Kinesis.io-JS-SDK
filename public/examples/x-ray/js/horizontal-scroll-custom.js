...
$(function(){
  ...
  var navHeight       = $("#navigation").height() + 160;
  ...
  $("#gridHolder").wrapInner("<table cellspacing='5'><tr>");
	$(".tileItem").wrap("<td class='tile' align='top'></td>")
	              .css("width", containerWidth-160 + "px")
	              .css("height", containerHeight-navHeight + "px")
	              .css("line-height", containerHeight-navHeight + "px")
	
  $(".tileItem img").css("height", containerHeight-navHeight + "px");
