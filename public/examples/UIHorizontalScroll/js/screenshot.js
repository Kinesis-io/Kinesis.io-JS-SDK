	...
	$.ajax({
		...
		success: function(success) {
			var _flashDiv     = document.createElement('div');
  			...
  			_flashDiv.setAttribute('style', 'top: 0; left: 0; opacity: 0; background-color: #ffffff; width:' + $(htmlobj).width() + 'px; height: ' + $(htmlobj).height() + 'px; z-index: 500; position: absolute');
